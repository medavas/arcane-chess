        ...
        if (
          ...
          if (sq + 9 === GameBoard.enPas) {
            if (
              ...
              AddEnPassantMove(
                MOVE(sq, sq + 9, GameBoard.pieces[sq + 10], PIECES.wQ, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq + 9, GameBoard.pieces[sq + 10], PIECES.wT, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq + 9, GameBoard.pieces[sq + 10], PIECES.wM, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq + 9, GameBoard.pieces[sq + 10], PIECES.wR, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq + 9, GameBoard.pieces[sq + 10], PIECES.wB, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq + 9, GameBoard.pieces[sq + 10], PIECES.wN, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq + 9, GameBoard.pieces[sq + 10], PIECES.wZ, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq + 9, GameBoard.pieces[sq + 10], PIECES.wU, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq + 9, GameBoard.pieces[sq + 10], PIECES.wS, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq + 9, GameBoard.pieces[sq + 10], PIECES.wW, MFLAGEP)
              );
            } else {
              AddEnPassantMove(
                MOVE(
          ...
          if (sq + 11 === GameBoard.enPas) {
            if (
              ...
              AddEnPassantMove(
                MOVE(sq, sq + 11, GameBoard.pieces[sq + 10], PIECES.wQ, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq + 11, GameBoard.pieces[sq + 10], PIECES.wT, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq + 11, GameBoard.pieces[sq + 10], PIECES.wM, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq + 11, GameBoard.pieces[sq + 10], PIECES.wR, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq + 11, GameBoard.pieces[sq + 10], PIECES.wB, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq + 11, GameBoard.pieces[sq + 10], PIECES.wN, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq + 11, GameBoard.pieces[sq + 10], PIECES.wZ, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq + 11, GameBoard.pieces[sq + 10], PIECES.wU, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq + 11, GameBoard.pieces[sq + 10], PIECES.wS, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq + 11, GameBoard.pieces[sq + 10], PIECES.wW, MFLAGEP)
              );
            } else {
              AddEnPassantMove(
                MOVE(
        ...
        if (
          ...
          if (sq - 9 === GameBoard.enPas) {
            if (
              ...
              AddEnPassantMove(
                MOVE(sq, sq - 9, GameBoard.pieces[sq - 10], PIECES.bQ, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq - 9, GameBoard.pieces[sq - 10], PIECES.bT, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq - 9, GameBoard.pieces[sq - 10], PIECES.bM, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq - 9, GameBoard.pieces[sq - 10], PIECES.bR, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq - 9, GameBoard.pieces[sq - 10], PIECES.bB, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq - 9, GameBoard.pieces[sq - 10], PIECES.bN, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq - 9, GameBoard.pieces[sq - 10], PIECES.bZ, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq - 9, GameBoard.pieces[sq - 10], PIECES.bU, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq - 9, GameBoard.pieces[sq - 10], PIECES.bS, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq - 9, GameBoard.pieces[sq - 10], PIECES.bW, MFLAGEP)
              );
            } else {
              AddEnPassantMove(
                MOVE(
          ...
          if (sq - 11 === GameBoard.enPas) {
            if (
              ...
              AddEnPassantMove(
                MOVE(sq, sq - 11, GameBoard.pieces[sq - 10], PIECES.bQ, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq - 11, GameBoard.pieces[sq - 10], PIECES.bT, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq - 11, GameBoard.pieces[sq - 10], PIECES.bM, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq - 11, GameBoard.pieces[sq - 10], PIECES.bR, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq - 11, GameBoard.pieces[sq - 10], PIECES.bB, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq - 11, GameBoard.pieces[sq - 10], PIECES.bN, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq - 11, GameBoard.pieces[sq - 10], PIECES.bZ, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq - 11, GameBoard.pieces[sq - 10], PIECES.bU, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq - 11, GameBoard.pieces[sq - 10], PIECES.bZ, MFLAGEP)
              );
              ...
              AddEnPassantMove(
                MOVE(sq, sq - 11, GameBoard.pieces[sq - 10], PIECES.bS, MFLAGEP)
              );
              AddEnPassantMove(
                MOVE(sq, sq - 11, GameBoard.pieces[sq - 10], PIECES.bW, MFLAGEP)
              );
            } else {
              AddEnPassantMove(
                MOVE(
